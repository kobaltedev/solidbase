...
For example, the dev app [extends the default theme](https://github.com/kobaltedev/solidbase/blob/main/dev/app.config.ts#L4) to add [OpenGraph](https://ogp.me) tags
...
Once the theme is defined, you can set it as the active theme in your SolidBase config with `createSolidBase`:
