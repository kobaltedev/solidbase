...
SolidBase is a fully featured, fully customisable [Static Site Generator](https://www.wikiwand.com/en/articles/Static_site_generator) for [SolidStart](https://start.solidjs.com/).
