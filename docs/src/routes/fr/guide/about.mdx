...
![Bêta](../../../../assets/beta.png)

# Introduction

SolidBase est un [Markdown](https://www.wikiwand.com/fr/articles/Markdown) ([MDX](https://mdxjs.com/)) basé sur [SolidStart](https://start.solidjs.com/) et est un [Générateur de Sites Statique](https://www.wikiwand.com/fr/articles/Générateur_de_site_statique).
